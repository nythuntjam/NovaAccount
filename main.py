...
║       PASSWORD        — Password users must enter to get file    ║
║       GITHUB_RAW_URL  — Raw GitHub URL of NovaYeasT.xlsx         ║
║                         e.g. [raw.githubusercontent.com](https://raw.githubusercontent.com/)  ║
║                              <user>/<repo>/main/NovaYeasT.xlsx   ║
║  4. Railway auto-detects Python and runs: python bot.py          ║
║                                                                  ║
║  OPTIONAL env vars:                                              ║
║       WEBHOOK_HOST    — Your Railway public domain (enables      ║
║                         webhook mode instead of polling)         ║
║                         e.g. [your-app.up.railway.app](https://your-app.up.railway.app)    ║
...
WEBHOOK_HOST: str | None = os.getenv("WEBHOOK_HOST")          # Optional
...
def log_access(user_id: int, username: str | None, chat_id: int) -> None:
